...
% 		\hline
% 		\multicolumn{2}{|c|}{\textbf{Áttekintés az algoritmusokról}}
% 		\\ \hline
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.5\textwidth,frame]{screenshot_route_card}
